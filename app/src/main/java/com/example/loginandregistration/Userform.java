...
//                final Calendar cmdr = Calendar.getInstance();
//                int day = cmdr.get(Calendar.DAY_OF_MONTH);
//                int month = cmdr.get(Calendar.MONTH);
//                int year = cmdr.get(Calendar.YEAR);
//                // date picker dialog
